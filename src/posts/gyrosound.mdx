...
The requirements of the project meant that it was necessary to identity a method that could be efficiently and with reasonable effectiveness, change the pitch of the sound that is being played. We decided to use `SoundPool` due to it's inbuilt ability to modulate frequency.
