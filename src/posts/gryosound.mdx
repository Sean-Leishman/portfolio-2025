...
<Figure className="w-auto h-500" src="/src/assets/playSound.png" />
...
<Figure className="w-auto h-500" src="/src/assets/editSound.png" />
...
<Figure className="w-auto h-500" src="/src/assets/recordSound.png" />
...
<Figure className="w-auto h-500" src="/src/assets/gyroArch.png" />
...
<Figure className="w-auto h-500" src="/src/assets/gyroSystem.png" />
...
<Figure className="w-auto h-500" src="/src/assets/profiler.png" />
...
<Figure className="w-auto h-500" src="/src/assets/metrics.png" />
