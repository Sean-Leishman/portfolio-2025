...
<Figure className="w-auto max-h-100 mx-auto" src="/src/assets/playSound.png" />
...
<Figure className="w-auto max-h-100 mx-auto" src="/src/assets/editSound.png" />
...
<Figure className="w-auto max-h-100 mx-auto" src="/src/assets/recordSound.png" />
...
<Figure className="w-auto max-h-100 mx-auto" src="/src/assets/gyroArch.png" />
...
<Figure className="w-auto max-h-100 mx-auto" src="/src/assets/gyroSystem.png" />
...
<Figure className="w-auto max-h-100 mx-auto" src="/src/assets/profiler.png" />
...
<Figure className="w-auto max-h-100 mx-auto" src="/src/assets/metrics.png" />
