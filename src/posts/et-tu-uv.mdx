...
<Figure className="w-auto max-h-128" src="/src/assets/fullsize.png" />
...
<Figure className="w-auto max-h-128" src="/src/assets/ettuuv-arch.png" />
...
<Figure className="w-auto max-h-128" src="/src/assets/timeseries.png" />
